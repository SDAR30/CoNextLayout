...
const ProtectedLayout = ({
    ...
    useEffect(() => {
        appwriteService.isLoggedIn()
            .then(setAuthStatus) //once promise resolves, call setAuthStatus with isLoggedIn() resolved value
            .finally(() => setLoader(false)); //finally runs regardless if user is logged in or not.
    }, []);
